...
namespace CustomPresentationControls.Behaviors
{
    public class PasswordBoxBindingBehavior
    {
        ...
        public static readonly DependencyProperty PasswordProperty = DependencyProperty.RegisterAttached("Password", typeof(string), typeof(PasswordBoxBindingBehavior), new PropertyMetadata(null, OnPasswordChanged));
        public static readonly DependencyProperty IsClearProperty = DependencyProperty.RegisterAttached("IsClear", typeof(bool), typeof(PasswordBoxBindingBehavior), new PropertyMetadata(false, OnIsClearToggled));
        public static readonly DependencyProperty IsBoundProperty = DependencyProperty.RegisterAttached("IsBound", typeof(bool), typeof(PasswordBoxBindingBehavior), new PropertyMetadata(false, OnIsBoundChanged));
        private static readonly DependencyProperty IsUpdatingProperty = DependencyProperty.RegisterAttached("IsUpdating", typeof(bool), typeof(PasswordBoxBindingBehavior), new PropertyMetadata(false));
        #endregion
